...
<head>
    ...
    <link rel="stylesheet" href="{{asset('front/css/fakeLoader.css')}}">
                ...
                <div class="row no-gutters filtr-container">
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="3">
                        <div class="content-image">
                            <a href="{{asset('front/images/portfolio1.jpg')}}" class="portfolio-popup">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="1">
                        <div class="content-image">
                            <a href="{{asset('front/images/portfolio2.jpg')}}" class="portfolio-popup">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="2, 1">
                        <div class="content-image">
                            <a href="{{asset('front/images/portfolio3.jpg')}}" class="portfolio-popup">
                                <img src="{{asset('front/images/portfolio3.jpg')}}" alt="">
                                <div class="image-overlay"></div>
                                <div class="portfolio-caption">
                                    <div class="title">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="3">
                        <div class="content-image">
                            <a href="{{asset('front/images/portfolio4.jpg')}}" class="portfolio-popup">
                                <img src="{{asset('front/images/portfolio4.jpg')}}" alt="">
                                <div class="image-overlay"></div>
                                <div class="portfolio-caption">
                                    <div class="title">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="1, 2">
                        <div class="content-image">
                            <a href="{{asset('front/images/portfolio5.jpg')}}" class="portfolio-popup">
                                <img src="{{asset('front/images/portfolio5.jpg')}}" alt="">
                                <div class="image-overlay"></div>
                                <div class="portfolio-caption">
                                    <div class="title">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 filtr-item" data-category="3, 1">
                        <div class="content-image">
                            <a href="{{asset('front/images/portfolio6.jpg')}}" class="portfolio-popup">
                                <img src="{{asset('front/images/portfolio6.jpg')}}" alt="">
                                <div class="image-overlay"></div>
                                <div class="portfolio-caption">
                                    <div class="title">
